...
demoForm.addEventListener("submit", (e) => {
  ...
  setTimeout(() => {
    try {
      ...
      const { scoreObj, features, shap, explanation, sentences, clusters } =
        result;
...
function sendChatMessage() {
  ...
  const responses = chatAssistantRespond(message);

  // Add bot responses with slight delay for better UX
  setTimeout(() => {
...
/**
 * chatAssistantRespond(userMessage)
 *
 * Intelligent chat responses based on keywords and context.
 * Returns an array of response strings.
 */
function chatAssistantRespond(userMessage) {
  const query = userMessage.toUpperCase();
  const responses = [];

  // Keywords mapping to responses
  const keywords = {
    // Scoring methodology
    "SCORING|SCORE|GRADE|MARK": [
      `<strong>📊 How Grading Works</strong><br/>
            Your answer is graded in <strong>two stages</strong>:<br/>
            <br/>
            <strong>Stage 1 (Rule-Based Floor):</strong><br/>
            • Checks if you mentioned all the key technical terms from the reference answer<br/>
            • Ensures you get credit for content you clearly wrote<br/>
            • Acts as a guaranteed minimum score<br/>
            <br/>
            <strong>Stage 2 (NLP Similarity):</strong><br/>
            • Compares semantic meaning (0.50 weight)<br/>
            • Measures vocabulary overlap (0.15 weight)<br/>
            • Evaluates phrasing similarity (0.05 weight)<br/>
            • Checks concept coverage (0.15 weight)<br/>
            • Assesses overall similarity (0.15 weight)<br/>
            <br/>
            <strong>Final Score = min(MaxScore, Stage1 + Stage2)</strong>`,
    ],

    // Semantic similarity
    "SEMANTIC|MEANING|SIMILAR|UNDERSTAND": [
      `<strong>🔍 Semantic Similarity</strong><br/>
            This measures how well the <strong>meaning</strong> of your answer matches the reference answer, independent of exact wording.<br/>
            <br/>
            • <strong>High (≥0.55):</strong> Your answer clearly demonstrates understanding<br/>
            • <strong>Medium (0.35-0.55):</strong> You understood some concepts but need more precision<br/>
            • <strong>Low (<0.35):</strong> The core meaning differs significantly<br/>
            <br/>
            <em>Tip: Focus on expressing the main idea clearly, not just copying words.</em>`,
    ],

    "VOCABULARY|WORDS|KEYWORDS|TERMS": [
      `<strong>📝 Vocabulary & Word Overlap</strong><br/>
            This measures how many key words and technical terms from the reference answer you used.<br/>
            <br/>
            • <strong>High (≥30%):</strong> You used most domain-specific terminology<br/>
            • <strong>Medium (15-30%):</strong> You used some key terms but could be more specific<br/>
            • <strong>Low (<15%):</strong> Very few matching words - use course vocabulary<br/>
            <br/>
            <em>Tip: Use the exact terminology from your textbook and course materials.</em>`,
    ],

    "CONCEPT|COVERAGE|ANCHOR|KEY IDEA": [
      `<strong>🎯 Key Concept Coverage</strong><br/>
            This measures what fraction of the essential concepts from the reference answer you addressed.<br/>
            <br/>
            • <strong>≥70%:</strong> Excellent - you covered almost all key points<br/>
            • <strong>40-70%:</strong> Good - but some important ideas are missing<br/>
            • <strong><40%:</strong> Incomplete - you missed critical concepts<br/>
            <br/>
            <em>Tip: Before answering, identify and list all the key concepts that must be covered.</em>`,
    ],

    "IMPROVE|BETTER|FEEDBACK|HELP": [
      `<strong>💡 How to Improve Your Answer</strong><br/>
            <br/>
            1. <strong>Re-read the question</strong> - Make sure you're addressing ALL parts<br/>
            2. <strong>Use key vocabulary</strong> -  Incorporate domain-specific terms from the reference<br/>
            3. <strong>Be complete</strong> - Cover all major concepts, don't leave gaps<br/>
            4. <strong>Be clear</strong> - Express ideas concisely and directly<br/>
            5. <strong>Be specific</strong> - Avoid vague language; use precise definitions<br/>
            6. <strong>Structure well</strong> - Use complete sentences; organize logically<br/>
            <br/>
            💬 The most common reason for score loss is <strong>missing key concepts</strong>, not exact wording.`,
    ],

    "STAGE|TWO|PAPER|EQUATION": [
      `<strong>⚙️ Stage 2: The Paper Formula</strong><br/>
            Based on <strong>Ahmad Ayaan & Kok-Why Ng (2024)</strong>, Stage 2 combines multiple metrics:<br/>
            <br/>
            <code style="background:var(--bg);padding:8px;border-radius:4px;">
            C<sub>nlp</sub> = 0.15·Jaccard + 0.05·Edit + 0.15·Cosine + 0.15·WordCount<br/>
            C = 0.5·Semantic + 0.5·C<sub>nlp</sub><br/>
            F = 0 if Semantic < 0.2; 1 if Semantic ≥ 0.9 AND WordCount ≥ 0.85; else C
            </code><br/>
            <br/>
            This ensures that very low semantic similarity always fails, but perfect semantic + complete content gets full credit.`,
    ],

    "EDIT|PHRASING|SENTENCE|STRUCTURE": [
      `<strong>➡️ Phrasing & Edit Similarity</strong><br/>
            This measures how similar your sentence structure and phrasing are to the reference.<br/>
            <br/>
            • <strong>High (≥55%):</strong> Your phrasing is very close to the reference<br/>
            • <strong>Medium (30-55%):</strong> Some structural similarity but different wording<br/>
            • <strong>Low (<30%):</strong> Very different phrasing - might indicate off-topic response<br/>
            <br/>
            <em>Tip: It's OK to rephrase with different words - but if phrasing is very different, ensure you're still on-topic.</em>`,
    ],

    "ACCURATE|PRECISION|CORRECT|ERROR": [
      `<strong>✅ Accuracy & Correctness</strong><br/>
            <br/>
            The system grades based on <strong>content coverage and semantic match</strong>, not perfect accuracy.<br/>
            <br/>
            • If your answer captures the main ideas correctly, you'll score well<br/>
            • Minor wording variations don't hurt your score<br/>
            • Covering all key concepts with correct understanding is most important<br/>
            • Small factual errors may reduce score if they affect understanding<br/>
            <br/>
            The grader focuses on: <strong>Did you understand and explain the core concept?</strong>`,
    ],

    "SHAP|ATTRIBUTION|FEATURE": [
      `<strong>📊 Feature Impact (SHAP Values)</strong><br/>
            This shows which individual metrics most influenced your score:<br/>
            <br/>
            • <strong>Green bars (+):</strong> This metric boosted your score above average<br/>
            • <strong>Red bars (-):</strong> This metric pulled your score below average<br/>
            <br/>
            By reading these bars, you can see which aspects of your answer were strongest and which need work.`,
    ],

    "SENTENCE|ATTRIBUTION|EXASAG": [
      `<strong>💬 Sentence-Level Attribution</strong><br/>
            Inspired by <strong>ExASAG (BEA 2023)</strong>, each sentence in your answer is rated independently:<br/>
            <br/>
            • <strong>Green (+):</strong> This sentence helped your score<br/>
            • <strong>Red (-):</strong> This sentence didn't match well<br/>
            <br/>
            You can see <strong>exactly which sentences were strong and which dragged your score down</strong>.`,
    ],

    "CLUSTER|CONCEPT|BUBBLE|MAP": [
      `<strong>🗺️ Concept Coverage Map</strong><br/>
            <br/>
            • <strong>Green bubbles:</strong> Key concepts you <strong>covered</strong> in your answer<br/>
            • <strong>Red bubbles:</strong> Key concepts you <strong>missed</strong><br/>
            • <strong>Bubble size:</strong> Importance/frequency of the concept<br/>
            <br/>
            This visual shows at a glance which important ideas you addressed and which you need to add.`,
    ],

    "LENGTH|SHORT|LONG|WORD LIMIT": [
      `<strong>📏 Answer Length</strong><br/>
            <br/>
            The system <strong>does NOT penalize short answers</strong> just for being short.<br/>
            <br/>
            Instead:
            • A short answer that covers all key concepts will score high<br/>
            • A long answer with missing concepts will score low<br/>
            • Quality > Quantity - complete and concise is better than rambling<br/>
            <br/>
            <em>Focus on covering all required concepts clearly, not on writing more.</em>`,
    ],

    "REFERENCE|IDEAL|MODEL|ANSWER": [
      `<strong>📖 Reference Answer</strong><br/>
            <br/>
            The reference (or ideal) answer is the <strong>standard against which your answer is compared</strong>:<br/>
            <br/>
            • It contains all the key concepts that should be covered<br/>
            • The system extracts the most important ideas from it<br/>
            • Your job is to express those same ideas in your own words<br/>
            • You don't need to copy the reference exactly<br/>
            <br/>
            <em>Strategy: Understand the core concepts, then explain them in your own words.</em>`,
    ],

    "THRESHOLD|MINIMUM|FAIL|ZERO": [
      `<strong>⚠️ Importance Thresholds</strong><br/>
            <br/>
            The grader has some firm rules:<br/>
            <br/>
            • <strong>Semantic similarity < 0.2:</strong> Answer likely off-topic → F = 0 (fails)<br/>
            • <strong>Semantic similarity ≥ 0.9 AND content ≥ 0.85:</strong> Near-perfect → F = 1.0 (full credit)<br/>
            • <strong>Otherwise:</strong> Blended score from all metrics<br/>
            <br/>
            <em>This prevents very low-quality answers from passing, and ensures very high-quality answers always pass.</em>`,
    ],

    "BIAS|FAIR|OBJECTIVE|EXPLAINABLE": [
      `<strong>🎯 Why This Grading System?</strong><br/>
            <br/>
            <strong>Traditional Problems Fixed:</strong><br/>
            • ❌ Length bias (longer ≠ better)<br/>
            • ❌ Black box scoring (you don't know why you lost points)<br/>
            • ❌ Inconsistent grading<br/>
            <br/>
            <strong>This System:</strong><br/>
            • ✅ Measures actual understanding, not length<br/>
            • ✅ Shows exactly which concepts you missed<br/>
            • ✅ Provides actionable feedback<br/>
            • ✅ Fair and consistent<br/>
            <br/>
            <em>Every point is traceable to a specific concept or metric.</em>`,
    ],
  };

  // Check each keyword pattern
  for (const [pattern, responseArray] of Object.entries(keywords)) {
    if (pattern.split("|").some((kw) => query.includes(kw))) {
      responses.push(
        responseArray[Math.floor(Math.random() * responseArray.length)],
      );
      break; // Return just one response
    }
  }
  ...
  if (responses.length === 0) {
    responses.push(
      `<strong>🤖 I'm here to help!</strong><br/>
            <br/>
            I can explain:<br/>
            • How scoring works and the two-stage pipeline<br/>
            • What each metric measures (semantic, vocabulary, concepts, etc.)<br/>
            • How to improve your answer<br/>
            • What the charts and visualizations mean<br/>
            <br/>
            Try asking about <strong>scoring</strong>, <strong>concepts</strong>, <strong>vocabulary</strong>, <strong>semantic similarity</strong>, or <strong>how to improve</strong>!`,
    );
  }
